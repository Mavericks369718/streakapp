...
user_problem_statement: "Test the streak tracking backend API with endpoints for health check, streak stats, completion marking, and history retrieval"
...
frontend:
  # No frontend tasks tested as per protocol
